...
Перед трассировкой длительных операций необходимо включить полный технологический журнал. Обязательно требуется собирать события `VRSREQUEST` и `VRSRESPONSE`.
