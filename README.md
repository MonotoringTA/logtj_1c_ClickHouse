...
> Инструмент для анализа производительности 1С: читает технологический журнал, собирает все события в отдельные пользовательские операции, отбирает проблемные по длительности и сохраняет их в ClickHouse для быстрого поиска узких мест и причин медленной работы.
...
Инструмент предназначен для анализа **длительных операций в системах 1С** на основе технологического журнала.
