...
1. Закройте форму обработки и вернитесь на страницу **«Операции»**.  
   ...
   ![Список операций](img/user_guide-2025-12-12-14-53-49.png)
...
4. Дополнительно отображается **статистика по событиям** внутри операции (например, `DBMSSQL`, `DBPOSTGRS`, `TLOCK`, `SCALL`):  
...
5. Визуальные колонки, сигнализирующие о наличии событий `TTIMEOUT`, `TDEADLOCK`, `EXCP` и другие системные события (`CLSTR`, `ADDIN` и т.д.)
